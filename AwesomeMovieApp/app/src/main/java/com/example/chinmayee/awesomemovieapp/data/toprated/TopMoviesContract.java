...
public class TopMoviesContract {

    public static final String CONTENT_AUTHORITY = "com.example.chinmayee.awesomemovieapp.data.toprated";

    public static final Uri BASE_CONTENT_URI = Uri.parse("content://" + CONTENT_AUTHORITY);
    public static final String PATH_MOVIES = "toprated";
