...
import static com.example.chinmayee.awesomemovieapp.data.favorites.FavMoviesContract.MoviesEntry.TABLE_NAME;
...
public class FavMoviesProvider extends ContentProvider {
    ...
    public static UriMatcher buildUriMatcher() {
        ...
        uriMatcher.addURI(FavMoviesContract.CONTENT_AUTHORITY, FavMoviesContract.PATH_MOVIES + "/#", MOVIES_WITH_ID);
            ...
            case MOVIES:
                ...
                try {
                    for (ContentValues value : values) {
                        ...
                        long _id = db.insert(FavMoviesContract.MoviesEntry.TABLE_NAME, null, value);
                        if (_id != -1) {
                            rowsInserted++;
                        }
                    }
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues values) {
        ...
        switch (match) {
            case MOVIES:
                ...
                if ( id > 0 ) {
                    returnUri = ContentUris.withAppendedId(FavMoviesContract.MoviesEntry.CONTENT_URI, id);
                } else {
    ...
    public int delete(@NonNull Uri uri, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        switch (sUriMatcher.match(uri)){
            ...
            case MOVIES_WITH_ID:{
                ...
                numRowsDeleted = mOpenHelper.getWritableDatabase().delete(FavMoviesContract.MoviesEntry.TABLE_NAME,
                        FavMoviesContract.MoviesEntry.MOVIE_ID+"=?",new String[]{id});
                break;
            }
            default:
